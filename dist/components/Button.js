...
export var Button = function (_a) {
    var children = _a.children, size = _a.size, type = _a.type, htmlType = _a.htmlType, props = __rest(_a, ["children", "size", "type", "htmlType"]);
    return (_jsx(ButtonDiv, __assign({ className: props.className, disabled: props.disabled }, { children: _jsx("button", __assign({}, props, { className: "".concat(size, " ").concat(type, " ").concat(props.disabled ? "disabled" : ""), type: htmlType }, { children: _jsx(_Fragment, { children: children }) })) })));
};
