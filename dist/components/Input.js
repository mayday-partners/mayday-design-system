...
export var Input = function (_a) {
    ...
    if (type === "date") {
        // TODO dayjs config
        return (_jsx(DatePickerDiv, { children: _jsx(DatePicker, { placeholder: "0000/00/00", onChange: function (event) { return setValue(event !== null && event !== void 0 ? event : ""); } }) }));
    }
    else
        return (_jsx(InputDiv, __assign({ className: props.disabled ? "disabled" : "" }, { children: _jsx("input", __assign({}, props, { onKeyDown: onKeyDown, onChange: function (event) { return setValue(event.target.value); } })) })));
};
